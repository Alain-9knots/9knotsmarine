...
const translations = {
  ...
  zh: {
    ...
    'project.label':   '项目',
    'project.title':   '蓝水巡航的\n全新愿景',
    'project.p1':      'Nine Knots Marine 源自多年的远洋经验，以及一个清晰的信念：理想的大洋航程，应当让游艇退居背景，让大海成为主角。',
    'project.p2':      '我们重新审视每一项惯例。我们研究了长航程中哪些部件会损坏、哪些会磨损、哪些会让船员疲惫，也研究了相反地，哪些因素能够带来信心与安宁。随后，我们诚实地设计出一艘能够回应这些问题的机动游艇。',
    'project.p3':      '它不是追求性能的快艇，也不是漂浮的公寓，而是一艘真正的远洋机动游艇：安全、可靠、自主，并且适合连续数周在船上生活，依然令人由衷满足。',
    'project.quote':   '"大海要求一艘游艇足够诚实。我们设计了一艘能够作答的船。"',
